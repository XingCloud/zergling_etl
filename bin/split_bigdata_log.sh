...
if [ ! -d ${adimp_log_new_path} ]; then
  mkdir -p ${adimp_log_new_path}
  chown hadoop:hadoop ${adimp_log_new_path}
fi
...
mv ${adimp_log} ${adimp_log_new_path}/adimp_${suffix}
chown hadoop:hadoop ${adimp_log_new_path}/adimp_${suffix}
